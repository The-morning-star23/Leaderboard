...
function BackgroundDecorations() {
  ...
  useEffect(() => {
    ...
    // Floating ribbons with elegant tones
    const ribbonColors = [
      "linear-gradient(135deg, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.05))", // white
  ...
  return (
    <div
      ref={containerRef}
      className="fixed inset-0 -z-10 pointer-events-none overflow-hidden bg-gradient-to-b from-yellow-100 via-yellow-200 to-yellow-100 bg-stripes"
    />
  );
}
